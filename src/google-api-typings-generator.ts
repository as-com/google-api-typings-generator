...
export class App {
    ...
    private processApi(destinationDirectory: string, api: gapi.client.discovery.RestDescription, actualVersion: boolean, url: string) {
        ...
        writer.writeLine(`//                 Andrew Sun <https://github.com/as-com>`)
        ...
        writer.writeLine(`// This file was generated by https://github.com/as-com/google-api-typings-generator. Please do not edit it manually.`);
